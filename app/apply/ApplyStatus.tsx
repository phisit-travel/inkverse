      ...
      <div className="w-full max-w-md text-center">
        {isPending && (
          <>
            ...
            <p className="text-gray-400 text-sm mb-4">
              ใบสมัครของ <span className="text-white font-medium">{application.penName}</span>{" "}
            ...
            <div className="mt-8 bg-[#141720] border border-yellow-500/20 rounded-2xl p-5 text-sm text-gray-400 text-left space-y-2">
        ...
        {isApproved && (
          <>
            ...
            <Link
              href="/upload"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#ff2d55] to-[#ff6b2b] text-white font-semibold hover:opacity-90 transition-opacity"
            >
