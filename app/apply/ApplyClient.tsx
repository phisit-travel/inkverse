          ...
          <>
            ...
            <div className="rounded-xl border border-[var(--border)] overflow-hidden">
              ...
              <ul className="px-4 pb-4 space-y-2 text-xs text-[var(--text-secondary)] leading-relaxed">
                {[
                  isWriter
                    ? "ผลงานต้นฉบับ: งานที่ลงต้องเป็นผลงานเขียนของคุณเอง (หรือมีสิทธิ์โดยชอบ) ไม่ลอกเลียนหรือละเมิดงานของผู้อื่น"
                    : "สิทธิ์ในการแปล: ต้องเป็นเจ้าของสิทธิ์หรือได้รับอนุญาตให้แปล/เผยแพร่ และยินดีถอดผลงานออกทันทีหากเจ้าของลิขสิทธิ์ร้องขอโดยชอบ",
                  "ความรับผิด: คุณรับผิดชอบเนื้อหาที่ลงทั้งหมดด้วยตนเอง และยินยอมชดใช้ความเสียหายให้แพลตฟอร์มหากเกิดข้อพิพาทด้านลิขสิทธิ์/กฎหมายจากผลงานของคุณ",
                  "เนื้อหาต้องห้าม: ห้ามเนื้อหาผิดกฎหมาย สื่อลามกที่เกี่ยวข้องกับผู้เยาว์ ความรุนแรง/สร้างความเกลียดชัง หรือละเมิดสิทธิผู้อื่นโดยเด็ดขาด",
                  "การจัดเรตอายุ: ตั้งเรตเนื้อหา 18+ ให้ถูกต้อง เพื่อให้ระบบกั้นอายุทำงานตามกฎหมาย",
                  "คุณภาพ & ความสม่ำเสมอ: รักษามาตรฐานและอัปเดตต่อเนื่อง ทีมงานมีสิทธิ์ตรวจสอบและลบเนื้อหาที่ไม่ได้มาตรฐานหรือผิดเงื่อนไข",
                  "ส่วนแบ่ง & การถอนเงิน: รับ 80% ของเหรียญที่ผู้อ่านใช้ปลดล็อก (แพลตฟอร์มหัก 20%) ถอนได้เมื่อถึงยอดขั้นต่ำ และอาจมีการตรวจสอบก่อนโอน",
                  "บัญชี: ให้ข้อมูลตามจริง ดูแลความปลอดภัยบัญชีของคุณเอง และไม่แอบอ้างเป็นบุคคลอื่น",
                  "การระงับสิทธิ์: หากฝ่าฝืนเงื่อนไข แพลตฟอร์มมีสิทธิ์ระงับสถานะครีเอเตอร์ ระงับการจ่ายรายได้ที่เกี่ยวข้อง หรือปิดบัญชี",
                  "ข้อมูลส่วนบุคคล: การเก็บและใช้ข้อมูลเป็นไปตามนโยบายความเป็นส่วนตัวของเว็บ",
                  "การพิจารณา: ช่วงเปิดรับอาจอนุมัติอัตโนมัติ และทีมงานมีสิทธิ์ตรวจสอบย้อนหลังหรือทบทวนสถานะได้",
                  "เงื่อนไขนี้อยู่ภายใต้กฎหมายไทย และอาจปรับปรุงได้ โดยจะแจ้งให้ทราบ",
                ].map((t, i) => (
              ...
              <p className="px-4 pb-3 -mt-1 text-[11px] text-[var(--text-muted)]">
                อ่านฉบับเต็ม:{" "}
                <Link href="/terms" target="_blank" className="text-[var(--text-secondary)] underline hover:text-[var(--text-primary)]">ข้อกำหนดการใช้งาน</Link>
                {" · "}
                <Link href="/privacy" target="_blank" className="text-[var(--text-secondary)] underline hover:text-[var(--text-primary)]">นโยบายความเป็นส่วนตัว</Link>
              </p>
